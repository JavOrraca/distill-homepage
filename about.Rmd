...
I am not a web developer by trade, however, I utilize the R stack to develop and deploy websites, package documentation, and interactive web applications. For interactive enterprise web apps, [R Shiny](https://shiny.rstudio.com/) is my framework of choice. `shiny` allows me to build apps with clean UIs and advanced modules, and I can inject HTML, CSS, and JavaScript for front-end customization.
